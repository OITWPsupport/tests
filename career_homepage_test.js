...
var URL = 'https://career.boisestate.edu';
...
driver.findElements({className: 'post-footer'}).then(function(elements) {
	console.log('Checking that the post-footer is present and accurate...');
		...
		require('./includes/footer.js').testPhoneNumber(webdriver, driver, '(208) 426-1747');
		require('./includes/footer.js').testDeptName(webdriver, driver, 'CAREER CENTER');
		require('./includes/footer.js').testEmail(webdriver, driver, 'CAREER@BOISESTATE.EDU');
		require('./includes/footer.js').testMailingAddress(webdriver, driver, 'ACADEMIC & CAREER SERVICE BUILDING, ROOM 111');
        } else {
...
// within Yoast SEO:
var URL = 'https://career.boisestate.edu/about-us/staff/jamie-jensen/dsc_0576/';
var redirect = 'https://career.boisestate.edu/about-us/staff/jamie-jensen/';
