...
var URL = 'https://aae.boisestate.edu';
...
driver.findElements({className: 'post-footer'}).then(function(elements) {
	console.log('Checking that the post-footer is present and accurate...');
		...
		require('./includes/footer.js').testDeptName(webdriver, driver, 'ADVISING AND ACADEMIC ENHANCEMENT');
		require('./includes/footer.js').testEmail(webdriver, driver, 'ACADEMIC@BOISESTATE.EDU');
		require('./includes/footer.js').testMailingAddress(webdriver, driver, 'ADVISING AND SUCCESS HUB ROOM 101');
        } else {
...
var URL = 'https://aae.boisestate.edu/testing';
var redirect = 'https://testing.boisestate.edu/';
require('./includes/redirect.js').testRedirect(webdriver, driver, URL, redirect);

var URL = 'https://aae.boisestate.edu/testing/compass/';
var redirect = 'https://testing.boisestate.edu/placement-tests/';
require('./includes/redirect.js').testRedirect(webdriver, driver, URL, redirect);
