...
var URL = 'https://veterans.boisestate.edu/library/product-category/business/';
...
driver.findElements({id: 'woocommerce_product_categories-3'}).then(function(elements) {
        var isPresent = elements.length;
        if (isPresent){
                console.log('Page element \'woocommerce_product_categories-3\' (\'Product Categories\' list) is here');
                ...
                console.log('ERROR: Page element \'woocommerce_product_categories-3\' is NOT FOUND');
        }
});
